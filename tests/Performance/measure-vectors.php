...
echo json_encode([
    ...
    'metric' => 'exact-cosine', 'ann' => false, 'samples' => 40, 'p95_ms' => round($p95, 2),
    'limit_ms' => 700, 'passed' => $p95 < 700, 'synthetic_vectors' => true,
...
if ($p95 >= 700) {
    ...
    throw new RuntimeException('Actual pgvector adapter p95 exceeds 700 ms.');
}
